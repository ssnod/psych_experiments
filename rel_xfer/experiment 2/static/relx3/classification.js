var classification = {
    ...
    start: function(params, next) {
        ...
        for (category of params['categories']) {
            responseBtns[category].btn.bind('click tap', function () {
                ...
                // if (acc == true) {
                //     feedbackTxt.text = 'Correct! This is a '.concat(params['btnLabels'][correctCategory])
                // } else {
                //     feedbackTxt.text = 'Incorrect... This is a '.concat(params['btnLabels'][correctCategory])
                // }
    ...
    initElements: function (params) {
        ...
        instructionsTxt = space.display.text({
            ...
            align: "center",
            font: "bold 25px sans-serif",
            text: "Click a button to select the correct category.",
            fill: "rgba(0,0,0,1)",
            zIndex: "front",
        })
